    ...
    return (
        <>
            <div class="mx-auto h-fit w-3/4 flex space-y-3 flex-col  shrink align-center text-center">
                ...
                <button onClick={friendReq} class="bg-blue-500 hover:bg-blue-700 text-white font-bold  px-4  m-auto rounded focus:outline-none focus:shadow-outline ">follow {info.currentFriend}</button>
